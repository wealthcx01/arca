...
# ARCA-68 — QA: test the auction aggregator end to end

**Status:** Todo · **Area:** QA/Auctions · **Depends on:** Build: ingest live auction listings for graded WOTC-era cards, Build: auctions view showing live listings next to card price history, Build: in-app notifications for watched auctions ending soon
