...
# ARCA-68 — Build: ingest live auction listings for graded WOTC-era cards

**Status:** Todo · **Area:** Auctions/ETL · **Depends on:** Research: which auction houses we can realistically pull live listings from
